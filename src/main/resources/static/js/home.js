...
//_____________________________play solo_____________________

const playSolo = document.getElementsByClassName('play-normal-btn')[0];
console.log(playSolo);

playSolo.addEventListener('click',(e)=>{

	e.preventDefault();

	window.location.href = "/playSolo";
